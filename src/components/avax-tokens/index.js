...
class AvaxTokens extends React.Component {
  ...
  generateCards () {
    ...
    // console.log('Avax wallet state: ', this.state.appData.avaxWalletState)
    const tokens = this.state.appData.avaxWalletState.balances

    // const tokens = this.state.appData.avaxWalletState.slpToken
